...
#define LAB_MK_QUAD_UV(x0, y0, z0, \
                       x1, y1, z1, \
                       x2, y2, z2, \
                       x3, y3, z3, \
                       u, v, \
                       ...
                       ur, vb, \
                       color, cull, light, vis)  \
    LAB_MK_QUAD(x0, y0, z0,  (u)+(ul), (v)+(vt), \
                x1, y1, z1,  (u)+(ur), (v)+(vt), \
                x2, y2, z2,  (u)+(ul), (v)+(vb), \
                x3, y3, z3,  (u)+(ur), (v)+(vb), \
                color,                           \
