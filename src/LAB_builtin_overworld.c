...
bool LAB_BuiltinOverworld_Init(void)
{
    ...
    if(!LAB_SurfaceDimension_CreateBiome(dim, &LAB_SURFACE_BIOME_FOREST, (LAB_SurfaceBiome_Blocks) {
    ...
    if(!LAB_SurfaceDimension_CreateBiome(dim, &LAB_SURFACE_BIOME_BIRCH_FOREST, (LAB_SurfaceBiome_Blocks) {
        .surface_block = LAB_BLOCK_GRASS,
        .ground_block = LAB_BLOCK_DIRT,
        .rock_block = LAB_BLOCK_STONE.raw,
        .ocean_block = LAB_BLOCK_WATER,
    ...
    if(!LAB_SurfaceDimension_CreateBiome(dim, &LAB_SURFACE_BIOME_TAIGA, (LAB_SurfaceBiome_Blocks) {
    ...
    if(!LAB_SurfaceDimension_CreateBiome(dim, &LAB_SURFACE_BIOME_PLAINS, (LAB_SurfaceBiome_Blocks) {
        .surface_block = LAB_BLOCK_GRASS,
        .ground_block = LAB_BLOCK_DIRT,
        .rock_block = LAB_BLOCK_STONE.raw,
        .ocean_block = LAB_BLOCK_WATER,
    ...
    if(!LAB_SurfaceDimension_CreateBiome(dim, &LAB_SURFACE_BIOME_DESERT, (LAB_SurfaceBiome_Blocks) {
    ...
    if(!LAB_SurfaceDimension_CreateBiome(dim, &LAB_SURFACE_BIOME_MOUNTAIN, (LAB_SurfaceBiome_Blocks) {
